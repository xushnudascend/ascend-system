...
const baseEn = {
  ...
  landingStep1T: "1. Identity Quiz",
  landingStep1D: "15 questions — AI builds your personal 30-day path.",
  landingStep2T: "2. Daily system",
  landingStep2D: "Habits, focus and contracts — automated every day.",
  landingStep3T: "3. Real results",
  landingStep3D: "XP, streaks and Life Score — when you fall, AI tells you why.",
  landingProofTitle: "By the numbers",
  landingProof1: "100+ courses",
  landingProof2: "100+ mentors",
  landingProof3: "12 languages",
  landingProof4: "0 excuses",
  landingTrust: "Not willpower — system. Not excuses — results.",
};
const baseRu = {
  ...
  landingStep1T: "1. Identity Quiz",
  landingStep1D: "15 вопросов — AI строит ваш личный путь на 30 дней.",
  landingStep2T: "2. Ежедневная система",
  landingStep2D: "Привычки, фокус и контракты — автоматически каждый день.",
  landingStep3T: "3. Реальный результат",
  landingStep3D: "XP, стрики и Life Score — упали? AI скажет почему.",
  landingProofTitle: "Цифры",
  landingProof1: "100+ курсов",
  landingProof2: "100+ личностей",
  landingProof3: "12 языков",
  landingProof4: "0 отговорок",
  landingTrust: "Не воля — система. Не отговорки — результат.",
};
const baseTr = {
